...
+-----------+--------------------------------------------+-------------------------+------------+
| Argon2    | AVX-512                                    | `argon2_avx512`         | 3.12.0     |
|           |                                            |                         |            |
...
+-----------+--------------------------------------------+-------------------------+------------+
| CTR       | AVX2                                       | `ctr_avx2`              | 3.12.0     |
|           |                                            |                         |            |
|           | SSSE3                                      | `ctr_simd32`            | 3.12.0     |
+-----------+--------------------------------------------+-------------------------+------------+
...
+-----------+--------------------------------------------+-------------------------+------------+
| SEED      | AVX-512 + GFNI                             | `seed_avx512_gfni`      | 3.12.0     |
|           |                                            |                         |            |
|           | AES-NI                                     | `seed_hwaes`            | 3.12.0     |
+-----------+--------------------------------------------+-------------------------+------------+
...
|           |                                            |                         |            |
|           | AES-NI                                     | `sm4_hwaes`             | 3.12.0     |
+-----------+--------------------------------------------+-------------------------+------------+
| Twofish   | AVX-512 + GFNI                             | `twofish_avx512`        | 3.12.0     |
+-----------+--------------------------------------------+-------------------------+------------+
| Whirlpool | AVX-512                                    | `whirlpool_avx512`      | 3.12.0     |
|           |                                            |                         |            |
|           | AVX2                                       | `whirlpool_avx2`        | 3.12.0     |
+-----------+--------------------------------------------+-------------------------+------------+
...
+-----------+--------------------------------------------+--------------------+------------+
| ARIA      | ARMv8 Cryptography Extensions              | `aria_hwaes`       | 3.12.0     |
+-----------+--------------------------------------------+--------------------+------------+
| Camellia  | ARMv8 Cryptography Extensions              | `camellia_hwaes`   | 3.12.0     |
+-----------+--------------------------------------------+--------------------+------------+
| ChaCha    | NEON                                       | `chacha_simd32`    | 2.8.0      |
+-----------+--------------------------------------------+--------------------+------------+
| NOEKEON   | NEON                                       | `noekeon_simd`     | 1.9.4      |
+-----------+--------------------------------------------+--------------------+------------+
| SEED      | ARMv8 Cryptography Extensions              | `seed_hwaes`       | 3.12.0     |
+-----------+--------------------------------------------+--------------------+------------+
...
|           |                                            |                    |            |
|           | ARMv8 Cryptography Extensions              | `sm4_hwaes`        | 3.12.0     |
+-----------+--------------------------------------------+--------------------+------------+
